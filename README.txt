...
best = familiarity * sharpness / ||(familiarity, sharpness)||
     = familiarity * sharpness / (sqrt(familiarity**2 + sharpness**2))
...
The folders enclosed contain the following tools:
    --> datasets
        * This is where some of the generated data can be found, including:
            --> mates
                * A collection of forced mates from my games.
